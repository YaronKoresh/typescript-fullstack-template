...
export default defineConfig([{
    ...
    external: ['./src/server/**/*', 'npm:@aws-sdk/client-s3', 'npm:@napi-rs/canvas'],
    outDir: 'dist/client',
    ...
    platform: 'node',
    noExternal: [/(.*)/],
    entry: ['src/server/index.ts', 'npm:@napi-rs/canvas'],
    external: ['./src/client/**/*'],
    outDir: 'dist/server',
    ...
    external: ['./src/client/**/*', 'npm:@aws-sdk/client-s3', 'npm:@napi-rs/canvas'],
